...
local function highlight(parent: Instance, color: Color3, text: string, stroke: Color3?, twisted: boolean?)
	...
	local function addBillboard(p: Instance, offset: Vector3?)
		local BillboardGui: BillboardGui =	createInstance("BillboardGui", p, { Adornee = p, AlwaysOnTop = true, Name = "I.C.H.O.R. | BillboardGui", Size = UDim2.fromScale(8, 4), StudsOffsetWorldSpace = offset or Vector3.zero, ZIndexBehavior = Enum.ZIndexBehavior.Sibling, ClipsDescendants = true })
